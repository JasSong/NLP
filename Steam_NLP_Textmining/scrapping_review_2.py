...
if __name__ == "__main__":
    ...
    #review 추출
    whole_id_review ={}
    for k , id in enumerate(appid_list[11890:]):
        main_url = "https://steamcommunity.com/app/"+id+"/reviews/#scrollTop=500000"
        # print(main_url)
        driver.get(main_url)
        time.sleep(2)
        if driver.current_url == main_url:
            ...
            button_cancel = '//*[@id="appHubLoadingPageModal"]/div[2]/a'

            try :
                driver.find_element_by_xpath(button_cancel).click()
            except :
                pass
            time.sleep(15)
            ...
            if len(pre_review) != 0:     #review유무 판단
                ...
                if driver.current_url == main_url:
                    ...
                    with open('steam_reviews_test2.txt','a',encoding='utf8',newline='') as f:
                        w = csv.writer(f)
